...
fn editing_ui(frame: &mut Frame, app: &mut App) {
...
fn deleting_ui(frame: &mut Frame, app: &mut App) {
    let popup_area = frame
        .area()
...
fn exiting_ui(frame: &mut Frame, app: &mut App) {
    let popup_area = frame
        .area()
